...
parser.add_argument('-dp', '--data-path', type=str, default=r"D:\My DataBases\ECG_data", metavar='str',
                    help="the path of the data. (default: 'D:\My DataBases\ECG_data')")
parser.add_argument('-lp', '--label_path', type=str, default=r'D:\My DataBases\ECG_data\REFERENCE.csv', metavar='str',
                    help="the path of the label file. (default: 'D:\My DataBases\ECG_data\REFERENCE.csv')")
